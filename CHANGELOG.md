...
### Added
- `mcpName` (`io.github.pixelx-jp/plateau-creative-mcp`) in `package.json` so the
  package can be listed in the official [MCP Registry](https://registry.modelcontextprotocol.io/).
